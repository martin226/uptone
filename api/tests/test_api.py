...
def test_twitter_preprocess():
    ...
    assert twitter_preprocess(
        'This is a tweet. #testing @martin') == 'tweet testing'
    assert twitter_preprocess(
        'Check this link out https://www.google.com') == 'check link'


def test_make_predictions():
    from api.predict import make_predictions
    tweets = ['This is a tweet. #testing @martin',
              'fuck everyone who supports human rights', 'what a bitch']
